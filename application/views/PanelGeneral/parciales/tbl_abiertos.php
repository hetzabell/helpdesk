        ...
        <table class="table">
            ...
            <tbody>
                ...
                if ($tickets) {
                    foreach ($tickets as $ticket) {
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?= base_url() . 'Panel-General/Ver-Ticket/' . $ticket->idIncidencia ?>" type="button" class="btn btn-default"><span class="glyphicon glyphicon-edit"></span></a>
                            </td>                
                        </tr>
                        <?php
                    }
                    ...
                    ?>
                    <tr>
                        <td colspan="6" class="text-center">No hay tickets en producción</td>
                    </tr>
<?php } ?>
            </tbody>
        </table>
