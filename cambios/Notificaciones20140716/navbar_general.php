        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="Usuario/Mi-Perfil"><span class="glyphicon glyphicon-cog"></span> Mi Perfil</a></li>
                        <li class="divider"></li>
                        <li><a href="<?= base_url(); ?>acceso/logout"><span class="glyphicon glyphicon-off"></span> Salir</a></li>
                    </ul>
                </li><!--
