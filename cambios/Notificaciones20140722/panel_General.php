...
class Panel_General extends Controlador_Privado {
    ...
    public function Ver_Ticket($idTicket = '') {
        ...
        $this->_bLecturaNotificaciones($idTicket, $datosTicket->iStatus);
    ...
    public function Actualizar_Notificaciones() {
        ...
        if ($this->input->post('iAccion') == 1) {
            $Notificaciones['icon'] = 'glyphicon-warning-sign';
        }
        if ($this->input->post('iAccion') == 5) {
            $Notificaciones['icon'] = 'glyphicon-envelope';
        }      
        if ($this->input->post('iAccion') == 7) {
            $Notificaciones['icon'] = 'glyphicon-ok';
        }
        if ($this->input->post('iAccion') == 8) {
            $Notificaciones['icon'] = 'glyphicon-transfer';
        }       
    ...
    private function _bLecturaNotificaciones($idIncidencia, $iStatus) {
        switch ($iStatus) {
            case 2:
            case 3:
