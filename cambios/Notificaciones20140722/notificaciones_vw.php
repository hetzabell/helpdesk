<?php if ($Notificaciones) { ?>
    ...
    <ul class="dropdown-menu">
        ...
        foreach ($Resultados as $Resultado) {
            $i++;
            ?>
            <li><a href="<?= base_url() ?>Panel-General/Ver-Ticket/<?= $Resultado->idIncidencia; ?>"><span class="glyphicon <?= $Resultado->sIconoNavBarDetalle; ?>"></span><i class="<?= $color ?>"> <?= $Resultado->sMensaje ?></i></a></li>
...
<?php } else { ?>
    <a href="#" class="dropdown-toggle disabled" style="pointer-events: none;cursor: default;" data-toggle="dropdown">
        ...
        <span class="badge"></span>&nbsp;<!--<b class="caret"></b>-->
